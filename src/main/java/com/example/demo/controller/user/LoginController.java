...
public class LoginController {
    ...
    public static String handleCheckRole() throws SQLException {
        ...
        if (isLoggedIn && user != null) {
           ...
           if(login != null){
               ...
               return switch (role) {
                   ...
                   case "user" -> "/com/example/demo/controller/auth/view/auth/salesdashboardlayout/sales-dashboard-layout.fxml";
                   case "supervisor" -> "/com/example/demo/controller/auth/view/auth/user-dashboard-layout.fxml";
    ...
    public void handleLogin(ActionEvent actionEvent) throws SQLException {
        ...
        if (user != null) {
            ...
            loadingOverlay.hide();
            handleNavigator(actionEvent, handleCheckRole(), true);
        } else {
            loadingOverlay.hide();
